...
#define VMM_FLAG_USER_RO       (PTE_AF | PTE_ATTRINDX(MT_NORMAL) | PTE_SH_INNER | PTE_USER | PTE_READONLY)
#define VMM_FLAG_USER_CODE     (PTE_AF | PTE_ATTRINDX(MT_NORMAL) | PTE_SH_INNER | PTE_USER | PTE_READONLY)
